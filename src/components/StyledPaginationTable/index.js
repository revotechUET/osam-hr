...
export default function StyledPaginationTable(props) {
    return <PaginationTable items = {exs} displayFields = {displays}
...
function HeaderCellRender(props) {
    return <div style={{border: "blue solid 1px", height: "30px"}}>
        <div onClick={props.onClick} style={{position: "relative", top: "50%", left: "50%", float: "left", 
