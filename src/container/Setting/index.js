            ...
            <div className="SettingPage">
                <div>
                    ...
                    <div className="fieldrow">
                        ...
                        <div className="fieldinput">
                            <button onClick={() => { this.setState({ workDayModal: true }) }}>Cài đặt</button>
                        </div>
                    </div>
                </div>
                <CenteredModal active={this.state.workDayModal} onCancel={() => { this.setState({ workDayModal: false }) }}>
                    <div className="work-day-setting-modal">
                        <div style={{ margin: "50px", height: "400px", overflow: "auto"}}>
                            <h1>Cài đặt ngày làm việc</h1>
